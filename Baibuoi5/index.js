...
function calcElecBill() {
    ...
    0 < n && 
    n <= 50 ? t = n * kw_1 : n > 50 && 
    n <= 100 ? t = 50 * kw_1 + (n - 50) * kw_2 : n > 100 && 
    n <= 200 ? t = 50 * kw_1 + 50 * kw_2 + (n - 100) * kw_3 : n > 200 && 
    n <= 350 ? t = 50 * kw_1 + 50 * kw_2 + 100 * kw_3 + (n - 200) * kw_4 : n > 350 ? t = 50 * kw_1 + 50 * kw_2 + 100 * kw_3 + 150 * kw_4 + (n - 350) * kw_5 : alert("Số kw không hợp lệ! Vui lòng nhập lại"),
...
function calcTax() {
    var e = document.getElementById("inputName2").value,
        ...
        n <= 6e7 ? t = .05 * n : n > 6e7 && 
        n <= 12e7 ? t = .1 * n : n > 12e7 && 
        n <= 21e7 ? t = .15 * n : n > 21e7 && 
        n <= 384e6 ? t = .2 * n : n > 384e6 && 
        n <= 624e6 ? t = .25 * n : n > 624e6 && 
        n <= 96e7 ? t = .3 * n : n > 96e7 ? t = .35 * n : alert("Số tiền thu nhập không hợp lệ"),
            t = new Intl.NumberFormat("vn-VN").format(t),
...
document.addEventListener("contextmenu", function (e) {
    ...
    document.onkeydown = function (e) {
        return 123 != (e = e || window.event).keyCode && 
